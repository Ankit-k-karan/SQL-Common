...
--select * from  PROP_RANK_0819 where Allocated_Target is not null and category ='TP'

--update PROP_RANK_0819 set Allocated_Target=Null where Allocated_Target is not null and category ='TP' 
--select * from VW_NSDC_DISTRICT_PRIORITY
