...
--select * from  PROP_RANK_0904 where Allocated_Target is not null and category ='TP'

--update PROP_RANK_0904 set Allocated_Target=Null where Allocated_Target is not null and category ='TP' 
--select * from VW_NSDC_DISTRICT_PRIORITY_v2

PRINT '-------- Allocate target to TP--------';  
declare CUR_EMP CURSOR FOR
select distinct pr.proposed_district,dc.DistrictCategory,dc.SeqNo		
