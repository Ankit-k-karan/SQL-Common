...
select Applicant_Pia_Id
		...
		, case when TPOrganizationType = 'NEW' and profit_tc>0 then profit_tc
				...
				else per_tc end 	maxTC into  NSDC_Allowed_TC 
				from (
select Applicant_Pia_Id
		,Turnove
		,TPOrganizationType
		,PercentageCandidates
		,Nature_Of_Entity
		,	case when ApplicantType='TP' and Nature_Of_Entity='Profit' and Turnove between 5000000 and 15000000 then 5
				 when ApplicantType='TP' and Nature_Of_Entity='Profit' and Turnove between 15000001 and 45000000 then 10
				 when ApplicantType='TP' and Nature_Of_Entity='Profit' and Turnove between 45000001 and 135000000 then 20
				 when ApplicantType='TP' and Nature_Of_Entity='Profit' and Turnove between 135000001 and 405000000 then 40
				 when ApplicantType='TP' and Nature_Of_Entity='Profit' and Turnove between 405000001 and 1215000000 then 80
				 when ApplicantType='TP' and Nature_Of_Entity='Profit' and Turnove >= 1215000001 then 100
				 else 0 end profit_tc
		,	case when ApplicantType='TP' and Nature_Of_Entity='Non-Profit' and Turnove between 2500000 and 15000000 then 5
				 when ApplicantType='TP' and Nature_Of_Entity='Non-Profit' and Turnove between 15000001 and 45000000 then 10
				 when ApplicantType='TP' and Nature_Of_Entity='Non-Profit' and Turnove between 45000001 and 135000000 then 20
				 when ApplicantType='TP' and Nature_Of_Entity='Non-Profit' and Turnove between 135000001 and 405000000 then 40
				 when ApplicantType='TP' and Nature_Of_Entity='Non-Profit' and Turnove between 405000001 and 1215000000 then 80
				 when ApplicantType='TP' and Nature_Of_Entity='Non-Profit' and Turnove >= 1215000001 then 100
				 else 0 end Nonprofit_tc
				 ,case when TPOrganizationType ='EXISTING' and  PercentageCandidates between 60 and 70 then 10
					when TPOrganizationType ='EXISTING' and  PercentageCandidates between 70.01 and 80 then 20
					when TPOrganizationType ='EXISTING' and  PercentageCandidates between 80.01 and 90 then 40
					when TPOrganizationType ='EXISTING' and  PercentageCandidates between 90.01 and 100 then 80
					else 0 end per_tc
