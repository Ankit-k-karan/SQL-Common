...
--select * from  PROP_RANK_0827 where Allocated_Target is not null and category ='TP'

--update PROP_RANK_0827 set Allocated_Target=Null where Allocated_Target is not null and category ='TP' 
--select * from VW_NSDC_DISTRICT_PRIORITY_v2
