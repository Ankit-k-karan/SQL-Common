--truncate table md_Sector_TPLED

--create Table md_Sector_TPLED(Id bigint not null identity(1,1) primary key
--								,StateId bigint null
...
inner join  (select 'Aerospace & Aviation' sector, 'Aerospace & Aviation Sector Skill Council' council
 union all select 'Agriculture' sector, '' council
 union all select 'Apparel, Made-Ups & Home Furnishing' sector, '' council
 union all select 'Automotive' sector, '' council
 union all select 'Banking, Financial Services and Insurance' sector, '' council
 union all select 'Beauty & Wellness' sector, '' council
 union all select 'Capital Goods' sector, '' council
 union all select 'Construction' sector, '' council
 union all select 'Domestic Worker' sector, 'Domestic Workers Sector Skill Council' council
 union all select 'Electronics & Hardware' sector, '' council
 union all select 'Food Processing' sector, 'Food Industry Capacity & Skill Initiative' council
 union all select 'Furniture & Fittings' sector, 'Furniture & Fittings Skill Council' council
 union all select 'Gems & Jewellery' sector, '' council
 union all select 'Green Jobs' sector, '' council
 union all select 'Handicrafts & Carpets' sector, 'Handicrafts & carpets Sector Skill Council' council
 union all select 'Hydrocarbon' sector, 'Hydro Carbon Sector Skill Council' council
 union all select 'Infrastructure Equipment' sector, 'Infrastructure Equipment Skill Council' council
 union all select 'Iron & Steel' sector, 'Indian Iron & Steel Sector Skill Council' council
 union all select 'IT-ITES' sector, '' council
 union all select 'Leather' sector, 'Leather Sector Skill Council' council
 union all select 'Life Sciences' sector, 'Life Sciences Sector Skill Development Council' council
 union all select 'Logistics' sector, '' council
 union all select 'Management and Entrepreneurship & Professional' sector, '' council
 union all select 'Media & Entertainment' sector, '' council
 union all select 'Mining' sector, 'Skill Council for Mining Sector' council
 union all select 'Paints & Coatings ' sector, '' council
 union all select 'Plumbing' sector, '' council
 union all select 'Power' sector, '' council
 union all select 'Retail' sector, '' council
 union all select 'Rubber' sector, 'Rubber Skill Development Council' council
 union all select 'Telecom ' sector, '' council
 union all select 'Textiles & Handlooms' sector, 'Textile Sector Skill Council' council
 union all select 'Tourism & Hospitality' sector, '' council
)sec on sec.council = a.sector
inner join md_sectors ms on ms.sector_name  = sec.sector
where ms.id is not  null and a.sector not in ('Sports, Physical Education, Fitness and Leisure Skills Council')
