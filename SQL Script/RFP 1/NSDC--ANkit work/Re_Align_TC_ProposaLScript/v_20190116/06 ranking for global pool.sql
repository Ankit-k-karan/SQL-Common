select * from Prop_Rank_v20190116
--Alter table Prop_Rank_v20190116 
...
--select * 
from Prop_Rank_v20190116 p inner join 
...
select isnull((SELECT  IS_NSDCPartner  FROM   [Pia_NSDCAssociation] PN
		...
		,Aspirational
		,PMKVY
		,PMKK from Prop_Rank_v20190116 pr
