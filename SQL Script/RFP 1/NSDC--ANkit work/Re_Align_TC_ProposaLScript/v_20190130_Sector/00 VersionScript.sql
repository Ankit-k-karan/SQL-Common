...
if not  exists(select * from sys.tables Where name  ='Prop_MainMaster_20190130')
begin

select * 
into Prop_MainMaster_20190130
...
if not  exists(select * from sys.tables Where name  ='ScoringDetails_20190130')
begin

select * 
into ScoringDetails_20190130
from ScoringDetails


End
go
if not  exists(select * from sys.tables Where name  ='Prop_TrainingCentre_20190130')
begin

select * 
into Prop_TrainingCentre_20190130
...
if not  exists(select * from sys.tables Where name  ='PROP_RANK_v5_20190130')
begin

select * 
into PROP_RANK_v5_20190130
from PROP_RANK_v5
...
if not  exists(select * from sys.tables Where name  ='PROP_RANK_v240_20190130')
begin

select * 
into PROP_RANK_v240_20190130
from PROP_RANK_v240
...
if not  exists(select * from sys.tables Where name  ='Prop_MainMaster_Realign_20190130')
begin

select * 
into  Prop_MainMaster_Realign_20190130
...
if not  exists(select * from sys.tables Where name  ='Prop_Training_PerposedTrade_20190130')
begin

select * 
into  Prop_Training_PerposedTrade_20190130
