...
if not  exists(select * from sys.tables Where name  ='Prop_MainMaster_20190107')
begin

select * 
into Prop_MainMaster_20190107
...
if not  exists(select * from sys.tables Where name  ='ScoringDetails_20190107')
begin

select * 
into ScoringDetails_20190107
from ScoringDetails


End
go
if not  exists(select * from sys.tables Where name  ='Prop_TrainingCentre_20190107')
begin

select * 
into Prop_TrainingCentre_20190107
...
if not  exists(select * from sys.tables Where name  ='PROP_RANK_v5_20190107')
begin

select * 
into PROP_RANK_v5_20190107
from PROP_RANK_v5
...
if not  exists(select * from sys.tables Where name  ='PROP_RANK_v240_20190107')
begin

select * 
into PROP_RANK_v240_20190107
from PROP_RANK_v240
...
if not  exists(select * from sys.tables Where name  =' Prop_MainMaster_Realign_20190107')
begin

select * 
into  Prop_MainMaster_Realign_20190107
...
WHERE  Prop_DD.L2Status ='Submitted'
       AND Prop_DD.L2Decision IN ('RQAVRS','RQA' )
...
--	   And (sd.Prop_Id in (select prop.Id from  Prop_MainMaster_20190107 prop 
...
--         or  sd.Prop_Id in (  select prop.Id from  Prop_MainMaster_20190107 prop  
...
-- And (p.id in (select prop.Id from  Prop_MainMaster_20190107 prop 
--	                          inner join Prop_MainMaster_Realign prop_Realign on  prop_Realign.Prop_Id = prop.Id 
--							   Where prop_Realign.Is_Active = 1
--							       And   prop.TrainingCenterType !=  prop_Realign.TrainingCenterType )
--         or  p.id in (  select prop.Id from  Prop_MainMaster_20190107 prop  
--	                          inner join  Pia pia on prop.Applicant_Pia_Id =pia.Id 
--							   Where  pia.pia_NAme + ' (' + pia.Pia_Registration_Number + ')' IN ( 'AAKANKSHA UTPRERAK SAMAJIK SANSTHA (NSDC_TP_14694)', 'ACCESS EDUTECH PRIVATE LIMITED (NSDC_TP_13674)', 'ADANI FOUNDATION (NSDC_TP_14085)', 'ADVANCE SMARTSKILLS PRIVATE LIMITED  (NSDC_TP_14511)',
--                                                                              'ALL INDIA INSTITUTE OF RURAL OPEN SCHOOLING (NSDC_TP_13177)', 'ASHIRWAD EDUCATIONAL SOCIAL WELFARE SOCIETY (NSDC_TP_13098)', 'CSB EDUCATION & SKILL (NSDC_TP_14388)', 'DIGITAL SAKSHARTA SANSTHAN (NSDC_TP_13722)',
--                                                                              'DIVYA DRISHTI SHIKSHA SAMITI (NSDC_TP_13473)', 'DORIC MULTIMEDIA PVT. LTD., (NSDC_TP_13758)', 'EARTH AND MOON HR PVT. LTD. (NSDC_TP_13109)', 'ECO MAITRY VIKAS SANSTHA (NSDC_TP_13366)',
