--select * from PROP_RANK_v240 v2 where new_allocated_target>0 and  new_allocated_target != allocated_target
update  PROP_RANK_v240 set Allocated_Target = 0 ,  Global_rank = null ,  Global_priority = null

--Alter table PROP_RANK_v240 
...
set v2.allocated_target =v5.allocated_target , v2.iscompleteDD =v5.iscompleteDD
 from PROP_RANK_v240 v2 inner join  PROP_RANK_v5 v5 on v2.prop_id = v5.prop_id

 select * from PROP_RANK_v240 Where iscompleteDD = 1 And  ISnull(New_Allocated_Target,0) = 0
...
--select * from  PROP_RANK_v240_20190107 Where  Prop_ID In ( select Prop_ID from PROP_RANK_v240 Where iscompleteDD = 1 And  ISnull(New_Allocated_Target,0) = 0)
...
set  v240.New_Allocated_Target  = v240_20190107.New_Allocated_Target
 from PROP_RANK_v240 v240
    inner join  PROP_RANK_v240_20190109 v240_20190107 on v240.Prop_ID =  v240_20190107.Prop_ID
...
-- select v2.* 
from PROP_RANK_v240 v2 inner join [vw_NSDC_SubmitProposalList] v on v2.prop_id = v.proposalid
...
set v2.New_Allocated_Target =v2.allocated_target 
 --select * 
 from PROP_RANK_v240 v2 where  v2.iscompleteDD is null and v2.category = 'Ct1'
