...
if not  exists(select * from sys.tables Where name  ='Prop_MainMaster_20190109')
begin

select * 
into Prop_MainMaster_20190109
...
if not  exists(select * from sys.tables Where name  ='ScoringDetails_20190109')
begin

select * 
into ScoringDetails_20190109
from ScoringDetails


End
go
if not  exists(select * from sys.tables Where name  ='Prop_TrainingCentre_20190109')
begin

select * 
into Prop_TrainingCentre_20190109
...
if not  exists(select * from sys.tables Where name  ='PROP_RANK_v5_20190109')
begin

select * 
into PROP_RANK_v5_20190109
from PROP_RANK_v5
...
if not  exists(select * from sys.tables Where name  ='PROP_RANK_v240_20190109')
begin

select * 
into PROP_RANK_v240_20190109
from PROP_RANK_v240
...
if not  exists(select * from sys.tables Where name  ='Prop_MainMaster_Realign_20190109')
begin

select * 
into  Prop_MainMaster_Realign_20190109
