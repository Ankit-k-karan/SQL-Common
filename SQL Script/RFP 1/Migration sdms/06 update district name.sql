update d 
set d.district_name =upper(ltrim(rtrim(a.district)) ) 
--select * 
from md_Districts d 
...
union all select 'Telangana' stat, '718' distid, 'Warangal Rural' district, 'Warangal Rural' mrigsdistrict,'type 4' typedist, 'No' asp, 'No'nopmk,'Yes' nopmm
