--select * from PROP_RANK_Gen

--update  PROP_RANK_Gen set Allocated_Target = null ,  Global_rank = null ,  Global_priority = null
			...
			@TCAllocated bigint =0;
				set @MaxTarget = case when @CategoryId ='Ct1' then 10000
									--	when @District_Category =8 then  900  --CHANGE 27.09.2018
										when @District_Category in (1,2) then 2000000 else 1200000000 end;
