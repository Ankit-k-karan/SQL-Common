...
select *			
			  from md_sectors order by 4
--update md_sectors set sector_name ='Apparels' where id =3
--update md_sectors set sector_name ='Instrumentation' where id =10046
--ALTER TABLE md_Trades
-- add  Costcategory nvarchar(3)
---sector
--insert into md_sectors (sector_code,sector_name ,remarks,is_active, cdate,cby)

select distinct case when a.sector ='Instrumentation, Automation, Surveillance and Communication' then 'IASC'
			when a.sector='Strategic Manufacturing' then 'SM' end secotr_code
		,a.sector, '', 1,getdate(),1 from md_sectors ms right join 
(
select 'Agriculture' Sector, 'Paddy Farmer' trade, 'AGR/Q0101' trade_code, '4' nsqf, 'II' categ
...
union all select 'Gems & Jewellery' Sector, 'Inclusion Plotter' trade, 'G&J/Q4203' trade_code, '4' nsqf, 'I' categ
union all select 'Gems & Jewellery' Sector, 'Spectrum Operator' trade, 'G&J/Q4204' trade_code, '3' nsqf, 'I' categ
...
union all select 'Gems & Jewellery' Sector, 'Blade Sawyer' trade, 'G&J/Q4403' trade_code, '3' nsqf, 'I' categ
union all select 'Gems & Jewellery' Sector, 'Blade Sawyer - Diamond Processing' trade, 'G&J/Q4403' trade_code, '3' nsqf, 'I' categ
union all select 'Gems & Jewellery' Sector, 'Laser Sawing Machine Operator' trade, 'G&J/Q4404' trade_code, '3' nsqf, 'I' categ
...
union all select 'Gems & Jewellery' Sector, 'Table Cutter' trade, 'G&J/Q4604' trade_code, '3' nsqf, 'I' categ
...
union all select 'Gems & Jewellery' Sector, 'Bottom Polisher' trade, 'G&J/Q4703' trade_code, '3' nsqf, 'I' categ
union all select 'Gems & Jewellery' Sector, 'Gridle Polisher  - Diamond Processing' trade, 'G&J/Q4704' trade_code, '3' nsqf, 'I' categ
union all select 'Gems & Jewellery' Sector, 'Symmetry Analyser Machine Operator' trade, 'G&J/Q4705' trade_code, '2' nsqf, 'I' categ
...
union all select 'Gems & Jewellery' Sector, 'Boiling In-charge' trade, 'G&J/Q4801' trade_code, '2' nsqf, 'I' categ
...
union all select 'Gems & Jewellery' Sector, 'Gemstone Rough Cutter' trade, 'G&J/Q6502' trade_code, '3' nsqf, 'I' categ
union all select 'Gems & Jewellery' Sector, 'Gemstone Pre-shaper ' trade, 'G&J/Q6602' trade_code, '3' nsqf, 'I' categ
union all select 'Gems & Jewellery' Sector, 'Pre-shaper  Gemstone Processing' trade, 'G&J/Q6602' trade_code, '3' nsqf, 'I' categ
union all select 'Gems & Jewellery' Sector, 'Gemstone Final Shaper and Calibrator' trade, 'G&J/Q6603' trade_code, '4' nsqf, 'I' categ
...
union all select 'Gems & Jewellery' Sector, 'Gemstone Driller' trade, 'G&J/Q6801' trade_code, '2' nsqf, 'I' categ
...
union all select 'Gems & Jewellery' Sector, 'Gemstone Thread Maker' trade, 'G&J/Q6901' trade_code, '2' nsqf, 'I' categ
...
union all select 'Gems & Jewellery' Sector, 'Merchandiser' trade, 'G&J/Q8201' trade_code, '6' nsqf, 'III' categ
...
union all select 'Gems & Jewellery' Sector, 'Appraiser and Valuer' trade, 'G&J/Q8502' trade_code, '5' nsqf, 'III' categ
...
union all select 'Mining' Sector, 'Jumbo Operator' trade, 'MIN/Q0432' trade_code, '4' nsqf, 'I' categ
...
where not exists (select 1 from md_sectors s where s.sector_name=a.sector)

insert into md_Trades(Sector_Name,trade_code,trade_name,nsqf_level,remarks,is_active,Is_Default,cdate,cby)
select ms.id,trade_code,trade,nsqf,categ,1,0,getdate(),1  from md_sectors ms inner join 
(select 'Agriculture' Sector, 'Paddy Farmer' trade, 'AGR/Q0101' trade_code, '4' nsqf, 'II' categ
union all select 'Agriculture' Sector, 'Wheat Cultivator' trade, 'AGR/Q0102' trade_code, '4' nsqf, 'II' categ
union all select 'Agriculture' Sector, 'Maize Cultivator' trade, 'AGR/Q0103' trade_code, '4' nsqf, 'II' categ
union all select 'Agriculture' Sector, 'Pulses Cultivator' trade, 'AGR/Q0104' trade_code, '4' nsqf, 'II' categ
...
where not exists (select 1 from   md_Trades t where t.trade_code = a.trade_code and t.sector_name = ms.id)
