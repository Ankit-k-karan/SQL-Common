--select * from  PROP_RANK_1109 where Allocated_Target between 1 and 29

--update PROP_RANK_1109 set  Allocated_Target = 0 where Allocated_Target between 1 and 29
...
--where exists (select 1 from PROP_RANK_1109 v where v.prop_id = d.propid and v.allocated_target=0)
--group by userid
