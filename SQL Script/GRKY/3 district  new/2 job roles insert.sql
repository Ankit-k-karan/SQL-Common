...
--select   distinct   a.sector,a.Statename,a.district, a.qpname,t.*
from (select 'Uttar Pradesh ' Statename, 'Chandauli ' district ,'AMH/Q0301' qpcode, 'Apparel, Made-Ups & Home Furnishing' sector,'Sewing Machine Operator ' qpname, '4' level, '567' districtlimit
...
union all select 'Uttar Pradesh ' Statename, 'Chandauli ' district ,'PSS/Q6001' qpcode, 'Power ' sector,'Electrician Domestic Solutions ' qpname, '3' level, '567' districtlimit
...
union all select 'Assam ' Statename, 'Nalbari' district ,'PSS/Q6001' qpcode, 'Power ' sector,'Electrician Domestic Solutions ' qpname, '3' level, '1000' districtlimit
...
inner  join md_sectors sec on sec.sector_name = a.sector --17,50
