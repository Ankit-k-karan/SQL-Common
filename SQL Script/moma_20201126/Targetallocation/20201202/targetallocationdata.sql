...
left join districtwise_jobrole_20201202 dtj on dtj.districtid=a.districtid and a.jobcode=dtj.tradecode and dtj.IsActive=1
--left join temp_rank b on b.tp_code=a.tp_code and b.districtid=a.districtid
--where a.jobcode like 'HSS/Q5501%'
