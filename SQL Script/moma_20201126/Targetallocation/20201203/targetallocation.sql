...
update prop_target_allocation_03122020 set allocatedtarget=case when @tpid in (30,95) then 0 else  @Target end ,remarks =case when @tpid in (30,95) then 'Tp allocation is cancelled' else  @remarks end
